...
export default function Header() {
  return (
    <header className="h-screen w-full bg-red-700  items-center rounded-bt-[100%]">
      <div className=" bg-white h-[90%] w-full rounded-br-[100%] items-center shadow-md bg-[url('https://www.redbulbinstitute.com/redbulb/gallery/pictures/fireExtiguisher.jpg')] bg-contain bg-no-repeat bg-center lg:flex">
