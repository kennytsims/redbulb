...
export default function About() {
  return (
    <section>
      <header className="flex flex-col items-center justify-center h-screen w-full bg-[url('https://www.redbulbinstitute.com/gallery/pictures/firstAid.jpg')]  bg-cover bg-no-repeat">
        <h1 className="text-2xl lg:text-6xl text-center font-bold  text-red-700 ">
          Keep Your Work Environment Safe
        </h1>
        <p className="text-xl text-red-700 m-5">
