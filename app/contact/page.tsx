...
export default function Contacts() {
  return (
    <header>
      <div className="flex items-center justify-center bg-[url('https://www.redbulbinstitute.com//redbulb/gallery/pictures/contacts.jpg')] w-full h-screen bg-cover bg-no-repeat bg-current">
