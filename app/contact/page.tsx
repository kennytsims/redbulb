...
export default function Contacts() {
  return (
    <header>
      <div className="flex items-center justify-center bg-[url('/gallery/pictures/contacts.jpg')] w-full h-screen bg-cover bg-no-repeat bg-current">
        <h1 className="text-6xl text-red-700  m-5">Contact to Enroll </h1>
      </div>
    ...
    rounded-full  border-red-700"
          />
          <h3 className="text-slate-600 text-lg ">+269 72204418</h3>
          <h3 className="text-slate-600 text-lg ">+269 75011003</h3>
        </div>
  ...
  rounded-full  border-red-700 "
          />
          <h3 className="text-slate-600 text-lg">admin@redbulbinstitute.com</h3>
   ...
   rounded-full  border-red-700 "
          />
          <h3 className="text-slate-600 text-lg">Plot 4067,Tlokweng</h3>
        </div>
      </article>
    </header>
  );
